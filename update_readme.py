...
def calculate_streaks_stats(
    ...
    # Expected format for TZ_OFFSET_HOURS is a float, e.g. "6" or "5.5"
...
def main() -> None:
    ...
    if not os.environ.get("GITHUB_TOKEN"):
        logging.warning(
            "GITHUB_TOKEN environment variable not found. "  # noqa: E501
            "Rate limiting might occur.")  # pylint: disable=line-too-long
