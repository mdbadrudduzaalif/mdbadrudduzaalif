...
def _parse_log_dates(log_entries: List[Dict[str, Any]]) -> Dict[str, Set[datetime.date]]:  # noqa: E501  # pylint: disable=line-too-long
    """Parse log dates."""
    topic_dates = {}
...
def calculate_streaks_stats(log_entries: List[Dict[str, Any]]) -> Dict[str, Dict[str, int]]:  # noqa: E501  # pylint: disable=line-too-long
...
def _fetch_github_api(url: str) -> Any:
    """Fetch github API."""
