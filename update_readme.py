...
def load_yaml(path: str) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.warning("Warning: File not found at %s", path)
        return {}
    except yaml.YAMLError as e:
        logger.warning("Warning: Error parsing YAML file at %s: %s", path, e)
        return {}
...
def calculate_streaks_stats(
    ...
    # Expected format for TZ_OFFSET_HOURS is an integer or float, e.g. "6", "5.5"  # noqa: E501  # pylint: disable=line-too-long
...
def main() -> None:
    ...
    if not os.environ.get("GITHUB_TOKEN"):
        logger.warning("Warning: GITHUB_TOKEN environment variable not found. Rate limiting might occur.")  # noqa: E501  # pylint: disable=line-too-long
